...
app.get('/posts/:postId', function(req, res) {
  let parName = _.lowerCase(req.params.postId);
   
  for (let i = 0; i < posts.length; i++) {
    if (parName === _.lowerCase(posts[i].postTitle)) {
      res.render("post", {postTitle: posts[i].postTitle, postPara: posts[i].postBody});
    }
  }
